...
root.resizable(5,5) #to make the window size fixed
#title of our window
...
city_head = Label(root, text='Check the Real Time Weather of City!\nEnter City Name', font='Arial 12 bold')
city_head.pack(pady=10)

inp_city = Entry(root, textvariable=city_value, width=24, font='Arial 14 bold')
inp_city.pack()

Button(root, command=showWeather, text="Show Real Time Weather", font="Arial 10", bg='lightblue', fg='green', activebackground="lightgreen", padx=5, pady=5).pack(pady=20)

# To show output
weather_now = Label(root, text=f"The Real Time Weather of the City!", font='Arial 12 bold')
